## geometric_shapes (jazzy) - 2.3.2-1

The packages in the `geometric_shapes` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy geometric_shapes --override-release-repository-push-url git@github.com:revyos-ros/geometric_shapes-release.git` on `Thu, 06 Mar 2025 09:40:14 -0000`
...
## geometric_shapes (humble) - 2.3.2-1
